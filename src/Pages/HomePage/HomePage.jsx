        ...
        <>
            <div className='lg:flex grid grid-cols-1 lg:grid-cols-2 w-11/12 mx-auto my-20 items-center'>
                <div className="lg:w-6/12">
                    <h1 className='text-4xl font-mono font-bold text-warning'>Welcome To Your <span className='animate-text bg-gradient-to-r from-orange-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-5xl font-black'>Food Restaurant</span></h1>
            ...
            <main className=''>
                ...
                <div className="bg-slate-100 mb-12 mx-12 rounded px-3">
                    <h1 className='text-center text-gray-800 pt-6 text-3xl font-bold underline my-12'>Restaurant Chef Services !!!</h1>
