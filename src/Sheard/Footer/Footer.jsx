    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-6 py-6 bg-slate-100'>
            ...
            <div className="">
                ...
                <p className='flex items-center gap-1 mt-3'><FaCopyright className='text-amber-500'></FaCopyright> <small className='text-gray-400'>Copyright by inforubel251@gmail.com</small></p>
            </div>
        </div>
    );
};
